...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_DRIVER_INF_PATH = L"drivers\\ez2DeskPrinterDriver\\ez2DeskPrinterDriver.inf";
    LPCWCH RD_PRINTER_PORT = L"ez2Desk Printer";
    LPCWCH RD_PRINTER_NAME = L"ez2Desk Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"ez2Desk v4 Printer Driver";
